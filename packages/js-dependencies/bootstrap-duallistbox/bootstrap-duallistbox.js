  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.clear1, .clear2').removeClass('btn-primary btn-xs').addClass('btn-mini');
        ...
        this.container.find('.clear1, .clear2').removeClass('btn-mini').addClass('btn-primary btn-xs');
