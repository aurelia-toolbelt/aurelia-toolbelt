...
@keyframes sk-stretchdelay {
  0%, 40%, 100% {
    ...
    -webkit-transform: scaleY(1.0);
      ...
      this.spinnerMsg = '<div class="rectangle"><div class="rect1"></div><div class="rect2"></div><div class="rect3"></div><div class="rect4">
    ...
    if (this.spinnerType === 'cubeGrid') {
      ...
      // tslint:disable-next-line:max-line-length
      this.spinnerMsg = '<div class="sk-cube-grid"><div class="sk-cube sk-cube1">
    ...
    if (this.spinnerType === 'fadingCircle') {
      ...
      // tslint:disable-next-line:max-line-length
      this.spinnerMsg = '<div class="sk-fading-circle"><div class="sk-circle1 sk-circle"></div><div class="sk-circle2 sk-circle"></div>
